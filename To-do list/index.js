...
// array 
let tasks = [
    {id:1, name:"ABC", status:"completed"},
    {id:2, name:"XYZ", status:"completed"},
    {id:3, name:"Prem", status:"completed"},
    {id:4, name:"PQR", status:"completed"},
    {id:5, name:"WXY", status:"completed"}
];
